"""
Haupteinstieg für die Ausführung der Simulation.

Entwickler-Kurzinfo:
- Zweck: Startet Einzelszenarien oder Szenariovergleiche.
- Inputs: scenario_key, include_plots/export Flags.
- Outputs: Konsolenausgabe, Plots und CSV-Exporte über Simulator.
- Typische Änderungen: Standardlauf, CLI-Fluss, Vergleichsoptionen.
"""
