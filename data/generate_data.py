"""Generiert eine einzige 1h-Zeitreihe mit PV-Leistung und Aussentemperatur für Zürich."""
...
def generate_pv_data(
    times: pd.DatetimeIndex, pv_area_m2: float = PV_AREA_M2
) -> pd.Series:
...
def build_dataset_1h() -> pd.DataFrame:
    ...
    return pd.DataFrame({"datetime": times, "pv_kw": pv_kw.values})
